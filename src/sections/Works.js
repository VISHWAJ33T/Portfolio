...
export default function Works() {
  ...
  return (
    <>
      <section className="container w-fit mx-auto mt-16 space-y-10 pb-16 sm:pb-16">
        ...
        <LoadAnimate amount={0}>
          <div className="flex w-full flex-col items-center">
            <ul
              id="projects-tab"
              className="-mb-px flex max-w-[100vw] gap-x-2 border-b border-gray-200 font-medium  hover:cursor-pointer dark:border-gray-700"
            >
              {TABS.map((tab, i) => (
                <li
                  key={`tab ${i}`}
