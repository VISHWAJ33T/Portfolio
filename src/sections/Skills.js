...
export default function Skills() {
  return (
    <>
      <section className="container w-fit mx-auto mt-16 text-center sm:mt-10">
        <HeadingAnimate>
        ...
        <LoadAnimate amount={0}>
          <div className="container w-fit mx-auto my-5 flex flex-col items-center p-5 md:flex-row">
            ...
            <div className="flex flex-col items-center text-center md:w-1/2 md:items-start md:pl-16 md:text-left lg:flex-grow lg:pl-24">
              ...
              {/* Tech Stack  */}
              <div className="my-3 flex flex-wrap justify-center sm:justify-start gap-x-4 gap-y-7 text-center sm:gap-x-7">
        ...
        <div className="container w-fit mx-auto px-3 py-6">
          <LoadAnimate amount={0}>
