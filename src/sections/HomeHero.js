...
import mainImg from '../assets/images/logo 3.png';
// other
...
export default function HomeHero() {
  ...
  return (
    <section className="container w-fit mx-auto mt-3 flex max-h-screen min-h-screen flex-col items-center justify-around px-5 md:px-1">
