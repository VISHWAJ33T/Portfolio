...
export default function Contact() {
  ...
  return (
    <section className="container w-fit mx-auto mt-5 px-5 pt-12 pb-10">
          ...
          <form ref={formRef} onSubmit={sendEmail}>
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="mt-4 w-full border-t border-neutral-700/50 p-2 pt-6 text-center dark:border-neutral-300/50">
                <a
                  href={`mailto:${contactEmail}?subject=Inquiry&body=Hello Vishwajeet`}
